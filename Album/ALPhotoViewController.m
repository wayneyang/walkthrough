...
- (void)centerScrollViewContents {
    ...
    CGFloat contentWidth = self.scrollView.zoomScale * self.imageView.image.size.width;
    CGFloat contentHeight = self.scrollView.zoomScale * self.imageView.image.size.height;
